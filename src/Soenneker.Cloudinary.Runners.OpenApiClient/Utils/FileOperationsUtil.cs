...
using Soenneker.Cloudinary.Runners.OpenApiClient.Utils.Abstract;
...
namespace Soenneker.Cloudinary.Runners.OpenApiClient.Utils;
...
public sealed class FileOperationsUtil : IFileOperationsUtil
{
    ...
    public async ValueTask Process(CancellationToken cancellationToken = default)
    {
        ...
        string openApiDocumentUrl = _configuration["Cloudinary:ClientGenerationUrl"] ?? "https://raw.githubusercontent.com/cloudinary/api-schemas/refs/heads/main/api/schema.yml";
        ...
        await _processUtil.Start("kiota", gitDirectory, $"kiota generate -l CSharp -d \"{filePath}\" -o src/{Constants.Library} -c CloudinaryOpenApiClient -n {Constants.Library}",
